    ...
    <form method="POST">
        <table width="100%" id="general-table">
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php foreach($data as $k => $v): ?>
                            <option value="<?=$v['id']?>"><?=str_repeat('-',$v['level']*4).$v['pri_name']?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type='text' name='m_name' maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
                ...
                <td>
                    <input type='text' name='a_name' maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
        </table>
